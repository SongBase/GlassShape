...
public class GlassShuttersNTR extends JDialog
{
   ...
   private static String title = "Glass Shutters 2.0.1";
      ...
      public void actionPerformed(ActionEvent a)
      {
         try
         {
            ...
            output.append("Glass Shutters - Application for creating CAD scripts for drawing \n" +
                          "Glass Shutters version 2.0.1  Copyright (C) 2012 - 2015  Donald G Gray \n" +
                          "\n" +
                          "http://gray10.com/ \n" +
                          "\n" +
                          "This program is free software: you can redistribute it and/or modify \n" +
   ...
   public static void main(String[] args)
   {
      try
      {
         ...
         System.out.println("Glass Shutters version 2.0.1");
